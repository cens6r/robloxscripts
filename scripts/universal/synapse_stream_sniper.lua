...
-- credits: DaDeliciousThug#7671 (id: 695003722924949675)
-- search discord ids on https://discord.id

--[[ script desc:
working synapse stream sniper script put username and userid and put the place id to stream snipe players or join players in game to troll them or whatever
]]

local Screenguini = Instance.new("ScreenGui")
syn.protect_gui(Screenguini)
...
UsernameLabel.Position = UDim2.new(.5, 0, 0, 0)
...
UserIdLabel.Position = UDim2.new(.5, 0, 0, 0)
