function LoadLibrary(a)
	return loadstring(game:HttpGet("https://pastebin.com/raw/UfzKgS6T", true))() -- archive:https://raw.githubusercontent.com/cens6r/robloxscripts/main/scripts/utils/json.lua
end
