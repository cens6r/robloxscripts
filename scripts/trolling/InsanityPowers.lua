-- Options --
_G.CharacterBug = false --Set to true if your uppertorso floats after executing.
...
local replace = ".Character"
local replacewith = '.Character["NullwareReanim"]'
local f = string.split(sentence, replace)
local newsentence = f[1].. replacewith.. f[2]
loadstring(newsentence)()
