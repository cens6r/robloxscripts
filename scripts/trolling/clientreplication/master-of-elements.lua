...
if whitetotem then
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(12,26))
elseif avatarstate then
v:FindFirstChildOfClass("Humanoid"):BreakJoints()
else
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(8,17))
end
...
for _,v in pairs(Hit) do
if bluetotem then
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(48,72))
elseif avatarstate then
...
for _,v in pairs(Hit) do
if redtotem then
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(5,15))
elseif avatarstate then
v.FindFirstChildOfClass("Humanoid").Parent:BreakJoints()
else
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(3,8))
end
vel = Instance.new("BodyVelocity",v:FindFirstChild("Torso") or v:FindFirstChild("UpperTorso")) 
vel.maxForce = Vector3.new(9999999999999,9999999999999,9999999999999)
torso = v:FindFirstChild("Torso") or v:FindFirstChild("UpperTorso")
...
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(24,35))
end
vel = Instance.new("BodyVelocity",v:FindFirstChild("Torso") or v:FindFirstChild("UpperTorso")) 
vel.maxForce = Vector3.new(9999999999999,9999999999999,9999999999999)
torso = v:FindFirstChild("Torso") or v:FindFirstChild("UpperTorso")
...
for _,v in pairs(Hit) do
if whitetotem then
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(4,6))
else
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(1,3))
end
vel = Instance.new("BodyVelocity",v:FindFirstChild("Torso") or v:FindFirstChild("UpperTorso")) 
vel.maxForce = Vector3.new(9999999999999,9999999999999,9999999999999)
torso = v:FindFirstChild("Torso") or v:FindFirstChild("UpperTorso")
...
for _,v in pairs(Hit) do
if whitetotem then
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(2,8))
elseif avatarstate then
v:FindFirstChildOfClass("Humanoid").Parent:BreakJoints()
else
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(6,12))
end
vel = Instance.new("BodyVelocity",v:FindFirstChild("Torso") or v:FindFirstChild("UpperTorso")) 
vel.maxForce = Vector3.new(9999999999999,9999999999999,9999999999999)
torso = v:FindFirstChild("Torso") or v:FindFirstChild("UpperTorso")
...
if bluetotem then
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(35,50))
elseif avatarstate then
v:FindFirstChildOfClass("Humanoid").Parent:BreakJoints()
else
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(25,35))
end
vel = Instance.new("BodyVelocity",v:FindFirstChild("Torso") or v:FindFirstChild("UpperTorso")) 
vel.maxForce = Vector3.new(9999999999999,9999999999999,9999999999999)
torso = v:FindFirstChild("Torso") or v:FindFirstChild("UpperTorso")
...
for _,v in pairs(Hit) do
if redtotem then
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(22,29))
elseif avatarstate then
v:FindFirstChildOfClass("Humanoid").Parent:BreakJoints()
else
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(12,22))
end
vel = Instance.new("BodyVelocity",v:FindFirstChild("Torso") or v:FindFirstChild("UpperTorso")) 
vel.maxForce = Vector3.new(9999999999999,9999999999999,9999999999999)
torso = v:FindFirstChild("Torso") or v:FindFirstChild("UpperTorso")
...
for _,v in pairs(Hit) do
if browntotem then
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(12,24))
else
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(6,12))
end
vel = Instance.new("BodyVelocity",v:FindFirstChild("Torso") or v:FindFirstChild("UpperTorso")) 
...
for _,v in pairs(Hit) do
if bluetotem then
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(55,72))
elseif avatarstate then
v:FindFirstChildOfClass("Humanoid").Parent:BreakJoints()
else
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(34,62))
end
vel = Instance.new("BodyVelocity",v:FindFirstChild("Torso") or v:FindFirstChild("UpperTorso")) 
vel.maxForce = Vector3.new(9999999999999,9999999999999,9999999999999)
torso = v:FindFirstChild("Torso") or v:FindFirstChild("UpperTorso")
...
for _,v in pairs(Hit) do
if redtotem then
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(24,33))
elseif avatarstate then
v:FindFirstChildOfClass("Humanoid").Parent:BreakJoints()
else
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(14,28))
end
vel = Instance.new("BodyVelocity",v:FindFirstChild("Torso") or v:FindFirstChild("UpperTorso")) 
vel.maxForce = Vector3.new(9999999999999,9999999999999,9999999999999)
torso = v:FindFirstChild("Torso") or v:FindFirstChild("UpperTorso")
...
for _,v in pairs(Hit) do
if browntotem then
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(36,64))
elseif avatarstate then
v:FindFirstChildOfClass("Humanoid").Parent:BreakJoints()
else
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(32,48))
end
vel = Instance.new("BodyVelocity",v:FindFirstChild("Torso") or v:FindFirstChild("UpperTorso")) 
vel.maxForce = Vector3.new(9999999999999,9999999999999,9999999999999)
torso = v:FindFirstChild("Torso") or v:FindFirstChild("UpperTorso")
...
for _,v in pairs(Hit) do
if browntotem then
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(54,64))
elseif avatarstate then
v:FindFirstChildOfClass("Humanoid").Parent:BreakJoints()
else
v:FindFirstChildOfClass("Humanoid"):TakeDamage(math.random(46,62))
end
vel = Instance.new("BodyVelocity",v:FindFirstChild("Torso") or v:FindFirstChild("UpperTorso")) 
vel.maxForce = Vector3.new(9999999999999,9999999999999,9999999999999)
torso = v:FindFirstChild("Torso") or v:FindFirstChild("UpperTorso")
