-- original v3rm thread: https://v3rmillion.net/showthread.php?tid=1181537
--[[
original v3rm desc:
I made this at 2am randomly and I have no use for it so I might as well just release it.
I am certain there are better ways to achieve grenade aimbot since this method literally uses brute force to calculate the trajectory. I won't even be surprised if it lags on some builds. Hopefully someone can improve this or will get inspired..
showcase: https://streamable.com/u5v2d0
script: loadstring(game:HttpGet("https://raw.githubusercontent.com/Singularity5490/random/main/pf_grenade_aimbot.lua"))()

btw credits to whoever wrote the grenade frame calculation in the old pf framework.

edit: i am perfectly aware that there are better ways to do this. i already mentioned that. i wanted to use this specific method due to the pf devs removing the grenade frames calculation from the client. this can have many uses.. grenade aimbot, prediction, etc..
]]

-- credits: https://v3rmillion.net/member.php?action=profile&uid=947830

-- preview: https://streamable.com/u5v2d0
